...
.. blogpost::
    ...
    **some useful commands once installed**
    ...
    ::
        ...
        python3 ./tools/ci_build/build.py --config RelWithDebInfo --use_mpi false --enable_training --use_cuda --cuda_home /usr/local/cuda-${CUDA_VERSION}/ --cudnn_home /usr/local/cuda-${CUDA_VERSION}/ --build_wheel --parallel --cuda_version=${CUDA_VERSION} --skip_tests --enable_training_torch_interop --build_dir ./build/linux_gpu
