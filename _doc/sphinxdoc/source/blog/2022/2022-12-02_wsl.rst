...
.. blogpost::
    ...
    **some useful commands once installed**
    ...
    ::
        ...
        sudo apt-key add /var/cuda-repo-wsl-ubuntu-${CUDA_VERSION_}-local/B81839D3.pub
        sudo apt-get update
    ...
    ::
        ...
        sudo dpkg -i nccl-local-repo-ubuntu2004-2.15.5-cuda11.8_1.0-1_amd64.deb
        sudo cp /var/nccl-local-repo-ubuntu2004-2.15.5-cuda11.8/nccl-local-14294EAC-keyring.gpg /usr/share/keyrings/
